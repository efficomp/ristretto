...
public class KMedians implements Clusterer {
	...
	/**
	 * The distance measure used in the algorithm, defaults to Manhattan distance.
	 */
	...
	/**
	 * Construct a default K-medians clusterer with 100 iterations, 4 clusters, a
	...
	/**
	 * Construct a default K-medians clusterer with the specified number of
	 * clusters, 100 iterations, a default random generator and using the Manhattan
	 * distance.
	 * 
	...
	/**
	 * Create a new K-medians clusterer with the given number of clusters and
	 * iterations. The internal random generator is a new one based upon the current
	 * system time. For the distance we use the Manhattan n-space distance.
	 * 
	 ...
	 * @return The clusters as an array of Datasets. Each Dataset represents a
	 *         cluster.
	 */
	public Dataset[] cluster(Dataset data) {
		...
		while (randomCentroids || (iterationCount < this.numberOfIterations && centroidsChanged)) {
			...
			// The new position of the centroid is the median of the current
			// cluster.

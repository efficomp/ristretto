...
/**
 * This index estimates the separation of clusters as the addition of distances
 * from each centroid to its farthest centroid. This index should be maximized.
 * 
 * @author Jesús González
 */
public class FarthestCentroids implements ClusterEvaluation {
	 ...
	 */
	public FarthestCentroids(DistanceMeasure dm) {
		this.dm = dm;
	}
	...
	public double score(Dataset[] clusters) {
		...
		for (int i = 0; i < centroids.size(); i++) {
			...
			maxSeparationsAcc += maxSeparation;
		}

		return maxSeparationsAcc;
	}

	/**
	 * Compares the two scores according to the criterion in the implementation Some
